...
!===============================================================================
  ...
  subroutine cmfd_power_execute()
    ...
    ! set up krylov info
    call KSPSetOperators(krylov, loss%oper, loss%oper, SAME_NONZERO_PATTERN, ierr)
    call KSPSetUp(krylov,ierr)

    ! calculate preconditioner (ILU)
    call PCFactorGetMatrix(prec,loss%oper,ierr)
...
!===============================================================================
  ...
  subroutine execute_power_iter()
    ...
    do i = 1,10000
      ...
      call MatMult(prod%oper,phi_o,S_o,ierr)
      ...
      call MatMult(prod%oper,phi_n,S_n,ierr)
